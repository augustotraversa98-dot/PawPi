...
//
//  • useLogAllGood — one-tap "all good today": writes a REAL wellness (general) log, which closes the
//    Care ring segment. Invalidates the ring + health queries so the UI updates instantly.
