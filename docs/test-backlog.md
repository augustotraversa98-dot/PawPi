...
```
**Wave 7 (tickets 2.68–2.75, scoped 2026-06-18):** migrations 0057–0061 above are PLANNED, not yet built —
...
reconciliation UI) add NO migration. **2.70** (transport live-GPS) is BUILT + harness-proven and its migration
**0056** is PENDING hand-apply (last applied on Supabase = 0055). New go-live env keys this wave: the **food-recall feed key + an external
